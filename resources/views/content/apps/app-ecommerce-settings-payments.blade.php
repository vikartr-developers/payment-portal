            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane fade show active" id="payments" role="tabpanel">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="card-title m-0">
                                ...
                                <p class="text-muted mb-0">Payment methods that are available with one of Parking System's
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <p>Payments that are made outside your online store. When a customer selects a manual payment
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-label-primary dropdown-toggle"
                                    data-bs-toggle="dropdown" aria-expanded="false">Add manual payment method</button>
