    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item"><a class="nav-link py-2" href="{{ url('app/ecommerce/customer/details/billing') }}"><i
                            class="ti ti-file-invoice me-1"></i>Address & Billing</a></li>
                <li class="nav-item"><a class="nav-link py-2"
                    ...
                    <div class="d-flex justify-content-between border-bottom mb-4 pb-2">
                        ...
                        <div class="action-icons">
                            <a href="javascript:;" class="text-body me-1" data-bs-target="#enableOTP"
                                data-bs-toggle="modal"><i class="ti ti-edit"></i></a>
            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive">
                    <table class="table border-top">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-truncate"><i class='mb-1 ti ti-brand-windows text-info me-3'></i> Chrome
                                    on Windows</td>
                            ...
                            <tr>
                                <td class="text-truncate"><i class='mb-1 ti ti-device-mobile text-danger me-3'></i> Chrome
                                    on iPhone</td>
                            ...
                            <tr>
                                <td class="text-truncate"><i class='mb-1 ti ti-brand-android text-success me-3'></i>
                            ...
                            <tr>
                                <td class="text-truncate border-bottom-0"><i
                                        class='mb-1 ti ti-brand-android text-success me-3'></i> Chrome on Android</td>
