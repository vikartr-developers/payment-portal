...
use App\Http\Controllers\CryptoManagementController;
...
// Profile Routes
Route::post('/profile/update/{id}', [UsersController::class, 'updateProfile'])->name('update-profile');
...
Route::middleware(['auth'])->prefix('app')->group(function () {
  ...
  Route::get('/profile', [UsersController::class, 'profile'])->name('profile.show');
...
Route::middleware(['auth'])->group(function () {
  // Show the account security page (if separate)
  Route::get('pages/account-settings-security', [SecurityController::class, 'showSecurityPage'])->name('security.page');

  // Change password POST route
  Route::post('account/change-password', [SecurityController::class, 'changePassword'])->name('security.change-password');
...
Route::middleware(['auth'])->prefix('app/payment')->group(function () {
  ...
  Route::patch('requests/restore/{id}', [RequestController::class, 'restore'])->name('requests.restore');
  Route::delete('requests/force-delete/{id}', [RequestController::class, 'forceDelete'])->name('requests.force-delete');
